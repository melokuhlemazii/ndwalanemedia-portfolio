          ...
          <div className="glass-card space-y-6">
            ...
            <div className="text-center space-y-4 pt-6 border-t border-border">
              ...
              <div className="flex justify-center gap-4">
                <a href="https://www.facebook.com/share/1QTWXrzt15/?mibextid=wwXIfr" className="social-icon" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                  <Facebook size={18} />
                </a>
                <a href="https://www.instagram.com/ndwalanemedia/" className="social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                  <Instagram size={18} />
                </a>
                <a href="https://www.tiktok.com/@photographyby_king" className="social-icon" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
